...
export default function PromotionBanner() {
    ...
    return (
        <div className='w-full text-center p-2 text-lg bg-gray-100 embla' ref={emblaRef}>
            <div className="embla__container">
                <div className="embla__slide">
                    <BsTruck className='inline mx-2'></BsTruck>
                    Envios para <strong>todo</strong> o Brasil!
                </div>
                <div className="embla__slide"><FaGlasses className='inline mx-2'></FaGlasses>Estampas <strong>esclusivas</strong></div>
